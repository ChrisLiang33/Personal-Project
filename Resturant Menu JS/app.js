...
const sectionsCenter = document.querySelector(".section-center");
...
function displayMenuItem(menueItem) {
  let displayMenu = menueItem.map((item) => {
    return `<article class="menu-item">
    <img src=${item.img} alt="menu" class=${item.title} />
    <div class="item-info">
      <header>
        <h4>${item.title}</h4>
        <h4 class="prics">${item.price}</h4>
      </header>
      <p class="item-text">
        ${item.desc}
      </p>
  ...
  sectionsCenter.innerHTML = displayMenu;
}
